...
The Role
********
To implement a role you have to extend the abstract class ``mango.role.api.Role``. Concrete instances of implementations can be added to the general ``mango.role.core.RoleAgent``. 
