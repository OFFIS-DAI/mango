...
*mango* allows the user to create simple agents with little effort and in the same time offers different options to structure agents with complex behaviour. The main features of mango are listed below.
